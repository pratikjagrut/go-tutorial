...
func main() {
	...
	// Checks whether path is absolute or not
	fmt.Println("Is 'Downloads/file' absolute: ", filepath.IsAbs("Downloads/file"))   // false
	fmt.Println("Is '/Downloads/file' absolute: ", filepath.IsAbs("/Downloads/file")) // true
